        ...
        <section class="section-2-pages-jeux, section-2-tlou">
            <?php if (isset($contenu1)) : ?>
                ...
                <div class="container-pages-jeux">
                    ...
                    <div class="contenu-jeux">
                        <iframe class="contenu-jeux-videos" width="90%" height="375" src="<?php echo $contenu1[3] ?>" 
            ...
            <?php if (isset($contenu2)) : ?>
                ...
                <div class="container-pages-jeux">
                    <div class="contenu-jeux">
                        <iframe class="contenu-jeux-videos" width="90%" height="375" src="<?php echo $contenu2[3] ?>" 
                            title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; 
                            picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>
                        </iframe>
                    </div>

        ...
        <section class="section-2-pages-jeux">
            <?php if (isset($contenu1)) : ?>
                ...
                <div class="container-pages-jeux">
                    ...
                    <div class="contenu-jeux">
                        <iframe class="contenu-jeux-videos" width="90%" height="475" src="<?php echo $contenu1[3] ?>" 
            ...
            <?php if (isset($contenu2)) : ?>
                ...
                <div class="container-pages-jeux">
                    <div class="contenu-jeux">
                        <iframe class="contenu-jeux-videos" width="90%" height="475" src="<?php echo $contenu2[3] ?>" 
